...
create_query = "CREATE TABLE IF NOT EXISTS {} (id TEXT, time REAL, tweet TEXT, sentiment REAL, topic TEXT)".format(settings.TABLE_NAME)
insert_query = "INSERT INTO {} (id, time, tweet, sentiment, topic) VALUES (?, ?, ?, ?, ?)".format(settings.TABLE_NAME)
delete_query = '''
DELETE FROM {0}
